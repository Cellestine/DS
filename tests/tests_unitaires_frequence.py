...
class TestFactorizedFunctions:
    """
    Classe de tests unitaires pour valider les fonctions de prétraitement
    du module old.factorized_functions.
    """
    ...
    def test_identify_column_types(self):
        """
        Teste que les colonnes numériques et catégorielles sont bien identifiées.
        """
    ...
    def test_fill_missing_values_with_invalid_data(self):
        """
        Vérifie que les NaN et les valeurs non numériques sont bien gérées :
    ...
    def test_encode_categorical_features(self):
        """
        Vérifie que l'encodage des variables catégorielles produit un DataFrame de même forme.
        """
    ...
    def test_drop_columns_with_high_missing_or_low_variance(self):
        """
        Vérifie que les colonnes avec faible variance ou beaucoup de valeurs manquantes
        sont bien supprimées.
        """
        df = pd.DataFrame(
            {
                "num1": [0, 0, 0, 0, 1],
        ...
        num_cols, cat_cols = ff.identify_column_types(df)
        cleaned_train_df, cleaned_test_df, dropped = (
            ff.drop_columns_with_high_missing_or_low_variance(
    ...
    def run_all_tests(self):
        """
        Lance tous les tests définis dans la classe.
        """
